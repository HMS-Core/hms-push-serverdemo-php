...
";
    ...
    private $defaultLogLevel = Constants::HW_PUSH_LOG_INFO_LEVEL;
    ...
    private function __construct()
    {
        ...
        $this->defaultLogLevel = $pushConfig->HW_DEFAULT_LOG_LEVEL;
        if (empty($this->defaultLogLevel)) {
            $this->defaultLogLevel = Constants::HW_PUSH_LOG_INFO_LEVEL;
        }
    }
